...
export default function Select({
  ...
  return (
    ...
    >
      ...
      {show ? (
        <div className="select-options animate-opacity bg-white dark:bg-slate-950 border border-solid border-slate-300 dark:border-slate-800 max-h-40 overflow-auto w-full shadow-[0_0_0.5rem_rgba(0,0,0,0.3)] z-10 rounded-md flex flex-col absolute top-[105%] left-[0%]">
